...
ob_start();
 ...
 if ( isset($_POST['submit']) ) {
  ...
  if ( !filter_var($email,FILTER_VALIDATE_EMAIL) ) {
   ...
   $query = "SELECT email FROM army1 WHERE email='$email'";
  ...
  echo $emailError;
   ...
   $query = "INSERT INTO army1(name,name1,reg,gender,address,email,phone) VALUES('$name','$name1','$reg','$gender','$add','$email','$phone')";
...
<body style="background-color:#e0bf94" background-repeat:no-repeat>
<script> 
		function validateForm()
		{
			...
			alert("Army Aplication submitted successfully");
		}
</script>
<h1>Army Application Form</h1>
<br/>
<h2 style="background-color:#725d42"><font-color:"silver">Registration form</font></h2>
<center>

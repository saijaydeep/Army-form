...
ob_start();
 ...
 if ( isset($_POST['submit']) ) {
  ...
  echo $emailError;
   ...
   $query = "INSERT INTO coast1(name,name1,reg,gender,address,email,phone) VALUES('$name','$name1','$reg','$gender','$add','$email','$phone')";
...
<body bgcolor="#b3bdce" background-repeat:no-repeat>
<script> 
		function validateForm()
		{
			...
			alert("Coast Guard Aplication submitted successfully");
		}
</script>
<h1>Coast Guard Application Form</h1>
<br/>

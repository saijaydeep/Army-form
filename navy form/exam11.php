...
ob_start();
 ...
 if ( isset($_POST['submit']) ) {
  ...
  if ( !filter_var($email,FILTER_VALIDATE_EMAIL) ) {
   ...
   $query = "SELECT email FROM navy1 WHERE email='$email'";
  ...
  echo $emailError;
   ...
   $query = "INSERT INTO navy1(name,name1,reg,gender,address,email,phone) VALUES('$name','$name1','$reg','$gender','$add','$email','$phone')";
...
<body background="ComputerDesktopWallpapersCollection (205).jpg" background-repeat:no-repeat>
<script> 
		function validateForm()
		{
			...
			alert("Navy Aplication submitted successfully");
		}
</script>
<h1>Navy Application Form</h1>
<br/><br/><br/>
<h2 style="background-color:orange">Registration form</h2>
<center>

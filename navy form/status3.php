...
ob_start();
 ...
 $afname=$_POST['fullname'];
 $query="SELECT * FROM airforce1 where reg='$afname'";
 ...
 if($count>0)
 {
     ...
     $gender=$_POST['gender'];
     $email=$_POST['email'];*/
     $dispquery="SELECT name,name1,reg,gender,email,phone FROM airforce1 where reg='$afname'";
